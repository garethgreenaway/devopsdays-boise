...
{% set branches = [] %}
{% for origin_branch in salt['git.ls_remote'](remote=project_url, opts='--heads', user='root', identity='salt://common/keys/crosconjenkins_id_rsa2', saltenv='croscon-saltmaster') %}
